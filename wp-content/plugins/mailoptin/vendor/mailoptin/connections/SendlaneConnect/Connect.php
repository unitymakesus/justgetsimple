    ...
    public function integration_customizer_controls($controls)
    {
        ...
        if (defined('MAILOPTIN_DETACH_LIBSODIUM') === true) {
            ...
            $controls[] = [
                ...
                'description' => __('Enter comma-separated list of tags that will apply to subscribers. This require "Single Opt In confirmation" to be enabled for your account. Contact Sendlane to enable this for you.', 'mailoptin')
            ];
    ...
    public function get_email_list()
    {
        try {
            ...
            if (isset($response->error)) {
                self::save_optin_error_log(json_encode($response->error), 'sendlane');
