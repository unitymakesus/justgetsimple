 ...
 * @version 1.6.12
 */
class EDD_SL_Plugin_Updater_4_GravityForm2PipeDriveCRM {
	private $api_url     = '';
	...
	public function check_update( $_transient_data ) {
		...
		$version_info = $this->h4lp_update_https_to_http( $version_info );
	...
	public function plugins_api_filter( $_data, $_action = '', $_args = null ) {
		...
		if ( empty( $edd_api_request_transient ) ) {
			...
			$api_response = $this->h4lp_update_https_to_http( $api_response );
	...
	function h4lp_update_https_to_http( $latest_info ){
